...
export const useCreateAccount = props => {
    ...
    const sanitizedInitialValues = useMemo(() => {
        const { email, firstName, lastName, middleName, custom_cust_attribute, ...rest } = initialValues;

        return {
            customer: { email, firstname: firstName, lastname: lastName,middlename: middleName,custom_cust_attribute: custom_cust_attribute },
            ...rest
        };
    }, [initialValues]);

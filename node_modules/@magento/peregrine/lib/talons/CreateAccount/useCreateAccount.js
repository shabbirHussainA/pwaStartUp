...
export const useCreateAccount = props => {
    ...
    const sanitizedInitialValues = useMemo(() => {
        const { email, firstName, lastName, middleName, customName, ...rest } = initialValues;

        return {
            customer: { email, firstname: firstName, lastname: lastName,middlename: middleName,custom_cust_attribute: customName },
            ...rest
        };
    }, [initialValues]);
